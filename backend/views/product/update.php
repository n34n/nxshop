...
$this->registerJs($this->render('_function.js'),\yii\web\View::POS_HEAD);
...
<!-- 创建规格弹出框  begin -->
		...
		'action' => '/nxshop/backend/web/index.php?r=product-specification/create&id='.$_GET['id'],
		]
		); ?>
...
<!-- 批量创建规格弹出框  begin -->
		...
		$form = ActiveForm::begin(
				...
				'action' => '/nxshop/backend/web/index.php?r=product-specification/batch-create&id='.$_GET['id'],
				]
		);
		?>
